...
export async function POST(request: Request) {
  try {
    ...
    5. Listado de noticias:
       ...
       - El título del artículo debe ser un enlace que apunte a "https://elironico.com/noticias/[CATEGORIA]/[SLUG]-[ID_DE_LA_NOTICIA]" o la forma SEO-friendly equivalente.
